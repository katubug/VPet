...
if (keyboard_check(vk_f1)) {
    ...
    draw_text(2, 20, "Image Index: " + string(image_index));
    draw_text(2, 26, "Sprite Width: " + string(sprite_get_width(sprite_index)));
    draw_text(2, 32, "Sprite Height: " + string(sprite_get_height(sprite_index)));
}
