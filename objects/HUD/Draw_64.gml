...
if(room==rm_garden)
{
	draw_text(x + 0, y + 400, string("Seed Planted: ") + string(string(obj_garden_plot.plot_seed_type)));
}

draw_text(x + 0, y + 20, string("Health: ") + string(global.game.health));
draw_rectangle(x + 100, y + 20, x + 100+(200*(global.game.health/20)), y + 40, 0);

draw_text(x + 0, y + 50, string("Hunger: ") + string(global.game.hunger));
draw_rectangle(x + 100, y + 50, x + 100+(200*(global.game.hunger/20)), y + 70, 0);

draw_text(x + 0, y + 80, string("Happy: ") + string(global.game.happiness));
